...
<!-- /circle-->
     <script type="text/javascript" src="{{ asset('public/js/circles.js') }}"></script>
                             <script>
                                var colors = [
...
<script src="{{ asset('public/js/flipclock.js') }}"></script>
...
<script src="{{ asset('public/js/bars.js') }}"></script>
